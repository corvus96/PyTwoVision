...
from pytwovision.models.yolov3_model import BuildYoloV3
from pytwovision.models.yolov3_tiny_model import BuildYoloV3Tiny
...
class ModelManager(ModelManagerInterface):
    ...
    def build_yolov3(self, name, backbone, num_class):
        ...
        """
        return self.model1.build(name, backbone, num_class)
    
    def build_yolov3_tiny(self, name, backbone, num_class):
        ...
        """
        return self.model2.build(name, backbone, num_class)

class Yolov3Model:
    def build(self, name, backbone, num_class):
        return BuildYoloV3(name, backbone, num_class)

class Yolov3TinyModel:
    def build(self, name, backbone, num_class):
        return BuildYoloV3Tiny(name, backbone, num_class)