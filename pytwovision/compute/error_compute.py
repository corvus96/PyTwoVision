...
def re_projection_error(objpoints, rvecs, tvecs, mtx, imgpoints, dist):
    ...
    The closer the re-projection error is to zero, 
    ...
    Then, we can calculate the absolute norm between what 
    ...
    Arguments:
        ...
        A 3xN/Nx3 1-channel or 1xN/Nx1 3-channel (or vector<Point3f> ), 
