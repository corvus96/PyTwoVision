...
class TestModelManager(unittest.TestCase):
    ...
    def test_yolov3_tiny_model_output(self):
        ...
        model_manager = ModelManager()
        conv_mbbox, conv_lbbox, _ = model_manager.build_yolov3_tiny(backbone_net, 80)(self.input_data.shape)
    ...
    def test_num_class_type(self):
        ...
        model_manager = ModelManager()
        try:    
            conv_mbbox, conv_lbbox, _ = model_manager.build_yolov3_tiny(backbone_net, 85.4)(self.input_data.shape)
        except ValueError:
